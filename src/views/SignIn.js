...
import {StyleSheet, TextInput, View, Text, TouchableWithoutFeedback, KeyboardAvoidingView, ActivityIndicator} from 'react-native'
...
const SignIn = ({navigation}) => {
  ...
  return(
    ...
    validationSchema={Yup.object({
      username: Yup.string()
        .required('Required')
        .max(322, 'Must be at most 32 chars long')
        .matches(/^[a-zA-Z0-9_-]+$/, 'Contains invalid characters'),
      password: Yup.string()
      .required('Required')
      .min(6, 'Mut be at least 6 long')
      .max(50, 'Must be at most 50 long')
    })}
    >{({
